...
function preload(){
  ...
  shooter_shooting = loadImage("assets/Attacck.png")

  zombieImg = loadAnimation("assets/Zombie11.png","assets/Zombie22.png","assets/Zombie33.png")
zombie_collided = loadAnimation("assets/ZombieMuerto.png");
...
player = createSprite(displayWidth-2200, displayHeight-300, 50, 50);
...
if(keyWentDown("space")){
  bullet = createSprite(player.x+10,player.y+10,20,10)
  bullet.velocityX = 20
...
if(zombieGroup.isTouching(bulletGroup)){
  for(var i=0;i<zombieGroup.length;i++){     
   ...
   if(zombieGroup[i].isTouching(bulletGroup)){
     zombieGroup[i].changeAnimation("collided",zombie_collided);
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(1000,2500),random(1000,1300),40,40)
